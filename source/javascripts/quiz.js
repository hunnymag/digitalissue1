var results = [
    {
        ...
        'quote': '<p><em>Yes, you can have my child, you can keep my child. Even with your obscenities and your talking cats. She will be strong there, well fed, well housed, well taught, she will grow up much better and stronger and smarter than I. I assent… She will never be broken as I was. She will be strange, but she will be glad and strong and she will not be afraid…. She will walk in strength like a man and never sell her body… People of the rainbow with its end fixed in earth, I give her to you!</em></p>',
    ...
    },
    {
        ...
        'quote': '<p><em>Though I had been nearly two years on Winter I was still far from being able to see the people of the planet through their own eyes. I tried to, but my efforts took the form of self-consciously seeing a Gethenian first as a man, then as a woman, forcing him into these categories so irrelevant to his nature and so essential to my own.</em></p>',
    ...
    },
    {
        ...
        'quote': '<p><em>“Don’t pull like that,” she said. “You’ll break your arm.”</em></p><p><em>So he pulled. The little limp-leather notebook fluttered out on to the floor, whence I picked it up. Everything went awfully quiet. The pain had stunned him, I guess.</em></p><p><em>She said in astonished good humor: “But why do you want to fight when you do not know how?”</em></p>',
    ...
    },
    {
        ...
        'quote': '<p><em>By means of stratagems he has stultified your understanding, he has woven around you a long list of defects that he declares essential to your wellbeing, to your nature. He has invented your history. But the time approaches when you shall crush the serpent under your heel, the time approaches when you can cry, erect, filled with ardour and courage, Paradise exists in the shadow of the sword.</em></p>',
